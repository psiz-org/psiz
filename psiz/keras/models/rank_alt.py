...
# ============================================================================
"""Module for RankAlt psychological embedding model.

Classes:
    RankAlt: Class that uses ordinal observations that are anchored by a
...
@tf.keras.utils.register_keras_serializable(
    package='psiz.keras.models', name='RankAlt'
)
class RankAlt(PsychologicalEmbedding):
