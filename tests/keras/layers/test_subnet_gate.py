...
from psiz.keras.layers import SubnetGate
...
def test_inp1_subnet_method(emb_subnets_determ):
    group_layer = SubnetGate(subnets=emb_subnets_determ, group_col=0)
...
def test_inp1_emb_call_determ_2d_input(
    ...
    group_layer = SubnetGate(subnets=emb_subnets_determ, group_col=1)
...
def test_inp1_emb_call_stoch_2d_input_rank0(
    ...
    """Test call that does not require an internal reshape."""
    group_layer = SubnetGate(subnets=emb_subnets_stoch_rank0, group_col=1)
...
def test_inp1_emb_call_stoch_2d_input_rank1(
    ...
    """Test call that does not require an internal reshape."""
    group_layer = SubnetGate(subnets=emb_subnets_stoch_rank1, group_col=1)
...
def test_inp1_emb_serialization(
    ...
    group_layer = SubnetGate(subnets=emb_subnets_stoch_rank1, group_col=0)

    # Get configuration.
    config = group_layer.get_config()

    # Reconstruct layer from configuration.
    group_layer_recon = SubnetGate.from_config(config)
...
def test_inpmulti_subnet_method(kernel_subnets):
    group_layer = SubnetGate(subnets=kernel_subnets, group_col=0)
...
def test_inpmulti_serialization(kernel_subnets, paired_inputs_v0, group_v0):
    """Test serialization."""
    group_layer_0 = SubnetGate(subnets=kernel_subnets, group_col=0)
    ...
    group_layer_1 = SubnetGate.from_config(config)
