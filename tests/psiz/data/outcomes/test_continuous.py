...
def test_init_0(o_continuous_a_4x1):
    ...
    * Default sample_weight
    ...
    desired_n_unit = 1
    desired_value = np.array([[[0.0]], [[2.0]], [[-0.1]], [[1.3]]], dtype=np.float32)
    ...
    np.testing.assert_array_equal(desired_value, o_continuous_a_4x1.value)
...
def test_init_1(o_continuous_aa_4x1):
    ...
    np.testing.assert_array_equal(desired_value, o_continuous_aa_4x1.value)
    np.testing.assert_array_equal(
...
def test_init_2(o_continuous_b_4x3):
    ...
    np.testing.assert_array_equal(desired_value, o_continuous_b_4x3.value)
    np.testing.assert_array_equal(
...
def test_init_3(o_continuous_c_4x3):
    ...
    np.testing.assert_array_equal(desired_value, o_continuous_c_4x3.value)
    np.testing.assert_array_equal(
...
def test_init_4(o_continuous_e_4x3):
    ...
    np.testing.assert_array_equal(desired_value, o_continuous_e_4x3.value)
    np.testing.assert_array_equal(
...
def test_export_2b(o_continuous_b_4x3):
    ...
    y, w = o_continuous_b_4x3.export(export_format="tfds", with_timestep_axis=False)
    tf.debugging.assert_equal(desired_y, y[desired_name])
    tf.debugging.assert_equal(desired_w, w[desired_name])
...
def test_export_3b(o_continuous_c_4x3):
    ...
    y, w = o_continuous_c_4x3.export(export_format="tfds", with_timestep_axis=False)
    tf.debugging.assert_equal(desired_y, y[desired_name])
    tf.debugging.assert_equal(desired_w, w[desired_name])
